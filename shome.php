      ...
      <div class="inner-width">
        ...
        <div class="services-container">
          ...
          <div class="service-box">
            ...
            <div class="service-title"><?php echo $_SESSION['user']; ?></div>
            <div class="service-desc">
             <strong> Contact:</strong> +91-<?php echo $_SESSION['contact']; ?><br>
			 <strong> Profession: </strong> <?php echo $_SESSION['type']; ?>
            </div>
          </div>
